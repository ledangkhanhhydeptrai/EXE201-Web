    ...
    const fetchContent = async () => {
      try {
        ...
        const response = await axios.get(
          "https://nongtraithucung.com/blogs/kien-thuc-the-gioi-pet/so-sanh-meo-anh-long-ngan-va-meo-anh-long-dai-ban-nen-chon-nuoi-giong"
        );
  ...
  return (
    <div className="container-fluid">
      <div className={styles.app}>
        ...
        >
          So sánh mèo Anh lông ngắn và mèo Anh lông dài: Bạn nên chọn nuôi giống
          nào?
        </h1>
